...
\usepackage[bottom=25mm,left=25mm,right=25mm]{geometry}

\usepackage{csquotes}
%\usepackage[round,sort&compress, authoryear]{natbib}
%\bibliographystyle{plainnat}
\usepackage{natbib}
\bibliographystyle{resources/styles/myapalike-german}
...
% Bezeichnungen für angezeigte Namen (z. B. Inhaltsverzeichnis etc.)
